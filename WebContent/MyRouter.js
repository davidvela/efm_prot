...
jQuery.sap.declare("pdm_demo.MyRouter");

sap.ui.core.routing.Router.extend("pdm_demo.MyRouter", {
	...
	_findSplitApp : function(oControl) {
		...
		//sAncestorControlNameOpt = "idFullScreenContainerControl";

		if (oControl instanceof sap.ui.core.mvc.View && oControl.byId(sAncestorControlName)) {
			return oControl.byId(sAncestorControlName);
		}
//		else if (oControl instanceof sap.ui.core.mvc.View && oControl.byId(sAncestorControlNameOpt)) {
//			return oControl.byId(sAncestorControlNameOpt);
//		}
